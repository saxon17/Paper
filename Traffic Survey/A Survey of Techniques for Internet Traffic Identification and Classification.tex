...
\\22:2,20:,22:-23:
\\22:2-22:11,22:14-20:,22:-23:-21:\\
$

\par
There are 6 different Markov states in the example.
The transition probability between states is derived from frequencies observed in the sequences, e.g. $P_{22:2-22:11,22:14} = 1$, while $P_{23:-23:} = 5$.
...
The probability that the following sequence of SSL/TLS message types: \\$\\22:2,20:,22:-23:-23:\\$\\ is a PayPal flow is equal to: $P({X_1,...,X_4}) = 0.055$.
In comparison, the probability computed from the Twitter model (cf. Fig. 5) is equal to 0.003\%, whereas the probability computed from the Skype fingerprint (cf. Fig. 9) is equal to 0.

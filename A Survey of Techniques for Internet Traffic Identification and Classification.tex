...
\thanks{M. Wei is with the Department
...
\begin{abstract}
%\boldmath
The techniques for internet traffic identification and classification are developing rapidly in recent years,
\end{abstract}
...
\begin{IEEEkeywords}
traffic identification, traffic classification, challenges, remarks.
\end{IEEEkeywords}
